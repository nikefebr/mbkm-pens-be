...
$query_child = "DELETE MBKM_REQUIREMENT WHERE MBKM_PROGRAM_ID = $item_id";
...
if ($execute) {
    $query = "DELETE MBKM_KATEGORI_PROGRAM WHERE ID = $item_id";
    ...
    createErrorResponse('Delete requirement failed!');
}
?>