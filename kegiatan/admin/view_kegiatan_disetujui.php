<?php
    ...
    if ($search == null) {
        ...
        FROM MBKM_PROGRAM P 
            RIGHT JOIN MBKM_REGISTRATION R ON P.ID = MBKM_PROGRAM_ID 
            LEFT JOIN MAHASISWA M ON R.STUDENT_ID = M.NRP
        WHERE (R.STATUS_KEGIATAN='Kegiatan Disetujui') AND (R.NAMA_KEGIATAN LIKE '%$search%' OR P.PROGRAM_NAME LIKE '%$search%' OR R.MITRA_NAME LIKE '%$search%' OR 
