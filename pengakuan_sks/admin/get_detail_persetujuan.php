<?php
    ...
    $query = 
        "SELECT K.ID, K.MBKM_REGISTRATION_ID, K.MBKM_COURSE_ID, M.KODE, M.MATAKULIAH, 
        M.SKS, K.NILAI, S.REASON, S.SUGGESTION, S.DOCUMENT, S.DOCUMENT_NAME 
        FROM MATAKULIAH_KONVERSI K
            RIGHT JOIN MATAKULIAH M ON M.NOMOR = K.MBKM_COURSE_ID
            LEFT JOIN PENGAKUAN_SKS S ON S.MBKM_REGISTRATION_ID = K.MBKM_REGISTRATION_ID
        WHERE S.MBKM_REGISTRATION_ID = $registrationId";
