<?php
    ...
    if ($search == null) {
        ...
        OR R.STATUS='Disetujui DPA' OR R.STATUS='Ditolak')
        ORDER BY R.ID";
        ...
        FROM MBKM_PROGRAM P 
            RIGHT JOIN MBKM_REGISTRATION R ON P.ID = MBKM_PROGRAM_ID 
            LEFT JOIN MAHASISWA M ON R.STUDENT_ID = M.NRP
        WHERE (R.DOSEN_WALI_ID = $dosenWaliId) AND (R.STATUS='Belum Disetujui' OR R.STATUS='Disetujui DPA' OR R.STATUS='Ditolak') 
