<?php
    ...
    if ($search == null) {
        ...
        OR R.STATUS='Disetujui Kaprodi' OR R.STATUS='Ditolak') 
        ORDER BY R.ID";
        ...
        FROM MBKM_PROGRAM P 
            RIGHT JOIN MBKM_REGISTRATION R ON P.ID = MBKM_PROGRAM_ID 
            LEFT JOIN MAHASISWA M ON R.STUDENT_ID = M.NRP
        WHERE (R.KAPRODI_ID = $kaprodiId) AND (R.STATUS='Disetujui DPA' OR R.STATUS='Disetujui Kaprodi' OR R.STATUS='Ditolak') 
